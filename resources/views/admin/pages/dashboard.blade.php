    ...
    <div class="row">
            ...
            <div class="card border-0 shadow rounded">
                ...
                <ul class="list-unstyled mb-0 p-4">
                    <li>
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-inline-flex">
                                <img src="https://shreethemes.in/doctris/layouts/assets/images/client/01.jpg" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
                                <div class="ms-3">
                    ...
                    <li class="mt-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-inline-flex">
                                <img src="https://shreethemes.in/doctris/layouts/assets/images/client/02.jpg" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
                                <div class="ms-3">
                    ...
                    <li class="mt-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-inline-flex">
                                <img src="https://shreethemes.in/doctris/layouts/assets/images/client/03.jpg" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
                                <div class="ms-3">
                    ...
                    <li class="mt-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-inline-flex">
                                <img src="https://shreethemes.in/doctris/layouts/assets/images/client/04.jpg" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
                                <div class="ms-3">
                    ...
                    <li class="mt-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-inline-flex">
                                <img src="https://shreethemes.in/doctris/layouts/assets/images/client/05.jpg" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
                                <div class="ms-3">
        ...
        <div class="col-xl-4 col-lg-6 mt-4">
            <div class="card chat chat-person border-0 shadow rounded">
                ...
                <ul class="p-4 list-unstyled mb-0 chat" data-simplebar style="background: url('https://shreethemes.in/doctris/layouts/assets/images/bg/bg-chat.png') center center; max-height: 295px;">
                    <li>
            ...
            <div class="card border-0 shadow rounded">
                ...
                <ul class="list-unstyled mb-0 p-4" data-simplebar style="height: 355px;">
                    <li class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                            <img src="https://shreethemes.in/doctris/layouts/assets/images/doctors/01.jpg" class="avatar avatar-small rounded-circle border shadow" alt="">
                    ...
                    <li class="d-flex align-items-center justify-content-between mt-4">
                        <div class="d-flex align-items-center">
                            <img src="https://shreethemes.in/doctris/layouts/assets/images/doctors/02.jpg" class="avatar avatar-small rounded-circle border shadow" alt="">
                            <div class="flex-1 ms-3">
                    ...
                    <li class="d-flex align-items-center justify-content-between mt-4">
                        <div class="d-flex align-items-center">
                            <img src="https://shreethemes.in/doctris/layouts/assets/images/doctors/03.jpg" class="avatar avatar-small rounded-circle border shadow" alt="">
                            <div class="flex-1 ms-3">
                    ...
                    <li class="d-flex align-items-center justify-content-between mt-4">
                        <div class="d-flex align-items-center">
                            <img src="https://shreethemes.in/doctris/layouts/assets/images/doctors/04.jpg" class="avatar avatar-small rounded-circle border shadow" alt="">
                            <div class="flex-1 ms-3">
                    ...
                    <li class="d-flex align-items-center justify-content-between mt-4">
                        <div class="d-flex align-items-center">
                            <img src="https://shreethemes.in/doctris/layouts/assets/images/doctors/05.jpg" class="avatar avatar-small rounded-circle border shadow" alt="">
                            <div class="flex-1 ms-3">
