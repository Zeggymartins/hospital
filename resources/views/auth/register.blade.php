...
<head>
    ...
    <body>
        ...
        <!-- Hero Start -->
        <section class="bg-half-150 d-table w-100 bg-light" style="background: url('https://shreethemes.in/doctris/layouts/assets/images/bg/bg-lines-one.png') center;">
            <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">                                               
                                                ...
                                                <input type="text" class="form-control" placeholder="First Name" id="name" class="block mt-1 w-full"  name="name" :value="old('name')" required autofocus autocomplete="name">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="email" class="form-control" placeholder="Email" id="email" class="block mt-1 w-full"  name="email" :value="old('email')" required autofocus autocomplete="email">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" placeholder="Password" id="password_confirmation" class="block mt-1 w-full"
                                                type="password"
